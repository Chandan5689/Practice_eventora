...
import profileImage from "../assests/profile2.png";
...
function Header() {
    ...
    return (
        <div className='header flex h-28 w-[100%] justify-between px-6 items-center  z-30 bg-white text-[19px]'>
            ...
            <section className='mobile-sidebar flex'>
                ...
                <ul className='header-link-items items-center font-medium gap-12 hidden lg:flex lg:pr-8 xl:pr-24 xl:text-[21px]'>
                    <li className="underlineRed cursor-pointer hover:text-[#f50606]"> About Us</li>
